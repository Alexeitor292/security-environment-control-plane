...
and covers **27 of the 97** catalogued codes: 26 in ``verify.py``, and exactly one —
...
Of the other 70, measured by asking whether the literal appears in each module outside the
...
* **42 are raised elsewhere** — ``identities.py``, ``profile.py``, ``manifest.py``,
...
This 23/5/42 split is re-measured on every run by
